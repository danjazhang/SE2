...
public class HotelFrame extends JFrame {
    ...
    public HotelFrame(Hotel hotel, HotelEventManager manager) {
        ...
        this.hotel2 = new Hotel(); // tweede hotel

        setTitle("Hotel Simulatie");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new BorderLayout());

        // leeg panel (nog GEEN layout geladen)
        ...
        importButton1.addActionListener(e -> {
            ...
            if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                panel1.setPreferredSize(new Dimension(
                        hotel1.breedte * HotelPanel.tileSize,
                        hotel1.hoogte * HotelPanel.tileSize
                ));
        ...
        importButton2.addActionListener(e -> {
            ...
            if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                panel2.setPreferredSize(new Dimension(
                        hotel2.breedte * HotelPanel.tileSize,
                        hotel2.hoogte * HotelPanel.tileSize
                ));
        ...
        // knop bovenaan zetten en toevoegen
