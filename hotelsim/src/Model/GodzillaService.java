...
public class GodzillaService {
    ...
    // Zet het Godzilla-vuur actief en markeer de aanval in het hotel.
    // Wordt één keer aangeroepen als het GODZILLA event binnenkomt.
    ...
    // Breidt het vuur uit naar de volgende kolom en markeert alle doden op die kolom.
    // Wordt elke tick aangeroepen door SimulatieController zolang godzillaActief gelijk is aan true.
    // De parameter currentHTE is de huidige tick, voor logberichten.
    ...
    // Zet de volgende kolom in brand en markeer alle personen op die kolom als gestorven.
